...
import { DEMO_EMAIL, DEMO_PASSWORD } from "./demo-constants";
...
/**
 * Idempotently ensures the shared demo account exists with sample data.
 * Used by the seed script and the one-click demo bootstrap endpoint.
 */
